        ...
        <div className="space-y-5">
          ...
          <fieldset>
            ...
            <div className="flex flex-wrap gap-2">
              {LEADS_PER_MONTH.map((opt) => {
                const selected = data.leadsPerMonth === opt;
                return (
                  <button
                    type="button"
                    key={opt}
                    onClick={() => {
                      update("leadsPerMonth", opt);
                      setTouched((t) => ({ ...t, leadsPerMonth: true }));
                    }}
            ...
            {touched.leadsPerMonth && errors.leadsPerMonth && (
