/**
 * Browser audio plumbing for the live voice demo. Ported from the VX1
 * ghl-agent copilot audio client — the same pipeline behind the
 * /try/<slug> prospect demos.
 *
 * Two halves:
...
export class MicCapture {
  ...
  private buffered = 0;
  private muted = false;
  /** Seconds of audio captured + emitted. */
  capturedSecs = 0;
...
export class PcmPlayer {
  ...
  /** Seconds of model audio enqueued. */
  playedSecs = 0;
